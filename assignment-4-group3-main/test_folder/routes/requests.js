...
const db = mysql.createConnection({
    host: 'localhost',
    user: 'root',
    password: '3316Lab4',    //Input Password
    database: 'stadiumdb',
});
...
router.post('/new', (req, res) => {
    ...
    console.log('Placed ticket in database with attributes:',requestData)
})
...
function randomRequestID(){
    ...
    //In form "Req-0000"
    randomID = "Req-"+zeroPad(Math.floor(Math.random()*9000+1000), 4)
    return randomID
}
